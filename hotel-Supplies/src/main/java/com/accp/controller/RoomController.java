...
public class RoomController {
    ...
    public String list(@ModelAttribute("roomNumber") String roomNumber,Model model,
                       @ModelAttribute("room")Room room, @RequestParam(name = "currentPage",defaultValue = "1")Integer currentPage){

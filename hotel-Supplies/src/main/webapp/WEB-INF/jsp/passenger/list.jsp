...
<!--   <link rel="stylesheet" href="/static/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    <div class="span5">
	    <div class="row-fluid">
		    ...
		    <form id="form22" action="${ctx}/Passenger/tolist.do" method="post" style="float: left;">
			   ...
			   <input id="txtnameid" name="name" class="textone roomnumberwidth"
					  style="border-radius:0px; border-top-left-radius:4px;
			   border-bottom-left-radius:4px;height:26px;" type="text" placeholder="请输入关键字" value="${passenger.name}">
    ...
    <br>
    <div class="dgvone">
       <table class="table table-condensed table-bordered table-striped" id="tableid">82
